"""Machine-readable schemas for the MF-01 product contract."""
...
def event_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "$id": "https://github.com/eoniclife/memory-firewall/schemas/memory-event.mf-01.json",
        "title": "MemoryEvent",
        "type": "object",
        ...
        "properties": {
            ...
            "user_or_tenant_scope": {"type": "string", "minLength": 1},
            ...
            "raw_or_redacted_content": {"type": "string"},
            "proposed_memory": {"type": "string"},
...
def finding_schema() -> dict[str, Any]:
    ...
    return {
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "$id": "https://github.com/eoniclife/memory-firewall/schemas/memory-finding.mf-01.json",
        "title": "MemoryFinding",
        "type": "object",
        "additionalProperties": False,
        "required": [
...
def schema_bundle() -> dict[str, Any]:
    """Return the complete public MF-01 contract bundle."""
